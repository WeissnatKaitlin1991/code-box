...
UUID=${UUID:-'1ba90690-e5a2-4235-b3e8-760f60ad0daa'}
VMESS_WSPATH=${VMESS_WSPATH:-'/qwedrtyil'}
VLESS_WSPATH=${VLESS_WSPATH:-'/w3ew'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/3wref'}
SS_WSPATH=${SS_WSPATH:-'/32rew'}
